...
import {
  TrainingActions,
  SET_AVAILABLETRAINING,
  SET_COMPLETEDTRAINING,
  START_TRAINING,
  STOP_TRAINING
...
export const getavailableTraining = (state: TrainingState) =>
  state.availableTraining;
export const getfinishedTraining = (state: TrainingState) =>
  state.finishedTraining;
